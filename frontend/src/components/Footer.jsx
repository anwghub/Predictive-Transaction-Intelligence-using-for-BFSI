...
export default function Footer() {
    return (
        <>
            ...
            <footer className="flex flex-col items-center justify-center w-full py-20 text-current/70">
                ...
                <p className="mt-4 text-center">Copyright © 2025 <a href="https://github.com/anwghub">anwghub</a>. All rights reservered.</p>
