    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="flex w-full max-w-5xl  rounded-lg overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-10 border-4 rounded-lg mr-10">
          <h2 className="text-3xl font-bold text-center mb-16">Forgot Password</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full hover:bg-[#6043D2] text-white text-lg font-semibold py-3 rounded-md bg-[#281b5d] transition duration-300 shadow-2xl " onClick={()=>navigate('/reset')}
            >
              Enter Email
            </button>
          </form>
